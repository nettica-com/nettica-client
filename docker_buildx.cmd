...
if "%~1"=="" (
  ...
  if "%~2"=="latest" (
    docker buildx build --build-arg="VERSION=%1" --platform linux/amd64,linux/arm64,linux/arm/v7 --provenance=true --sbom=true -t nettica/nettica-client:latest -t nettica/nettica-client:%1 . --push
  ) else (
