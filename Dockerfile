...
RUN curl -s -o /etc/apt/sources.list.d/nettica.list https://ppa.nettica.app/nettica.list
RUN curl https://ppa.nettica.app/nettica.gpg | gpg -o /usr/share/keyrings/nettica.gpg --dearmor --batch --yes
